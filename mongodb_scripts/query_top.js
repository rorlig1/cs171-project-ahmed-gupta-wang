...
db.business2.find({categories: {$in: ["Mexican", "American (Traditional)", "Sandwiches", "Pizza", "Nightlife", "Bars","Italian", "American (New)"]}}, {categories:1, _id:0}).forEach(printResults)
